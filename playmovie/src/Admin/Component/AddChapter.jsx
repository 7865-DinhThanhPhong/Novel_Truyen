...
import ErrorMessage from "./ErrorMessage"; // Import component ErrorMessage (nếu bạn có)
import { Editor } from '@tinymce/tinymce-react';
import he from 'he';
import DOMPurify from 'dompurify';

function AddChapter({ story, onContentChange }) {
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const response = await axios.post(
                `http://localhost:8082/chapters/${story.id}`,
                chapterData
            );

            console.log("Thêm chapter thành công:", response.data);
